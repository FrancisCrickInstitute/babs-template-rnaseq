...
ParamList <- R6::R6Class("ParamList",
                        private = list(
                          ...
                          descriptions=list(alpha="The threshold of statistical significance is {deparse(alpha)}",
                                            ...
                                            gene_clust="When we need to choose clusters of genes, use {if (gene_clust<1) paste(gene_clust, ' of the whole genelist as an average cluster size') else gene_clust} clusters",
